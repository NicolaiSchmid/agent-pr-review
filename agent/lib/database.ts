...
export const store = {
  ...
  rerunDisposition: (taskId: string) => convex().query(query("rerunDisposition"), args({ taskId })) as Promise<{ result_state: "reopened" | "superseded" | "cancelled" | "completed"; conclusion: "success" | "failure" | null; body: string | null } | null>,
